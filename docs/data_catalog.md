...
|---|---|---
| customer_key | INT | Surrogote key, uniquely identifying each customer record in the dimension table.
...
| sales_amount | INT | The total monetary value of the sale for the line item, in whole number currency units (e.g. 25).
| quantity | INT | The number of units of the product ordered for the line item (e.g. 1).
| price | INT | The price per unit of the product for the line item, in whole number currency units (e.g. 25).
